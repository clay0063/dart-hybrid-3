class Student {
  ...
  void plus(Map<String, String> person) {
    if (person.containsKey("first") &&
        person.containsKey("last") &&
  ...
  void remove(String field) {
    return people.removeWhere((person) => person.containsValue(
        field)); //does not cause errors if something doesn't exist
  }
}
